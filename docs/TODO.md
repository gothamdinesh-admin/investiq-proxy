...
- [~] **Multi-portfolio support** — _v0.21a + v0.21b SHIPPED._
  ...
  - **Remaining:** v0.21d — per-portfolio snapshots (Performance/Time Travel scoped; needs migration 017 + Edge-Function touch — its own focused pass), family aggregate summing a member's portfolios.
