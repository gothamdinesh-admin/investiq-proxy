...
- **Phase 2+ — TODO:** widen field coverage (subtitles, button labels, empty-states per section) by extending `CMS_SCHEMA` + tagging; and add non-text field types to the Studio:
